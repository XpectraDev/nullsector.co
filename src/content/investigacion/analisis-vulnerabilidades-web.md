...
---
![Auditando aplicaciones web con SkipFish](https://nullsector.co/wp-content/uploads/2018/02/ghost_1-150x150.png)
...
![Auditando aplicaciones web con SkipFish](https://nullsector.co/wp-content/uploads/2018/02/Captura.png)
...
![Auditando aplicaciones web con SkipFish](https://nullsector.co/wp-content/uploads/2018/02/Captura2-e1518242269590.png)
...
![Auditando aplicaciones web con SkipFish](https://nullsector.co/wp-content/uploads/2018/02/Captura3.png)

**4 –** Inicia la magia!, recuerda que el tiempo de duración varia según lo robusto del aplicativo .

![Auditando aplicaciones web con SkipFish](https://nullsector.co/wp-content/uploads/2018/02/Captura4.png)

**5 –**  Cuando se complete la auditoria nos indicara la ruta donde se almaceno el informe correspondiente.

![Auditando aplicaciones web con SkipFish](https://nullsector.co/wp-content/uploads/2018/02/Captura5-1.png)

**6 –** Abrimos el la ruta donde generamos el informe y abrimos el archivo **«index.html».**

![Auditando aplicaciones web con SkipFish](https://nullsector.co/wp-content/uploads/2018/02/Captura7.png)
...
![Auditando aplicaciones web con SkipFish](https://nullsector.co/wp-content/uploads/2018/02/Captura6.png)

![Auditando aplicaciones web con SkipFish](https://nullsector.co/wp-content/uploads/2018/02/Captura8.png)

**8 –** Encontramos una vulnerabilidad de RFI(Remote File Inclusion) vamos a explotarla!.

![Auditando aplicaciones web con SkipFish](https://nullsector.co/wp-content/uploads/2018/02/Captura9.png)

**9 –** Podemos incluir archivos mediante la url, en este caso buscamos una imagen en Internet y le cambiamos el parámetro.

![Auditando aplicaciones web con SkipFish](https://nullsector.co/wp-content/uploads/2018/02/Captura10.png)
