...
![Ataque mediante Powershell inyectando una ShellCode directamente en memoria](/investigacion/ataque-mediante-powershell-inyectando-una-shellcode-directamente-memoria/powershell-logo.png)
...
![Ataque mediante powershell injectando una shellcode directamente en memoria](/investigacion/ataque-mediante-powershell-inyectando-una-shellcode-directamente-memoria/Captura1-300x52.png)

2 – Accedemos a el directorio creado en la ruta actual

cd unicorn/

![Ataque mediante powershell injectando una shellcode directamente en memoria](/investigacion/ataque-mediante-powershell-inyectando-una-shellcode-directamente-memoria/Captura2-300x93.png)
...
![Ataque mediante Powershell inyectando una ShellCode directamente en memoria](/investigacion/ataque-mediante-powershell-inyectando-una-shellcode-directamente-memoria/Captura5-300x20.png)

4 – Ahora procedemos a verificar que existan los archivos «unicorn.rc» y «powershell\_attack.txt» en el directorio actual

ls

![Inyectando una shellcode directamente en memoria mediante Powershell](/investigacion/ataque-mediante-powershell-inyectando-una-shellcode-directamente-memoria/Captura4-300x27.png)
...
![](/investigacion/ataque-mediante-powershell-inyectando-una-shellcode-directamente-memoria/Captura6-300x51.png)

6 – Procedemos a abrir nuestra msfconsole con los parámetros del archivo «unicorn.rc»

msfconsole -r unicorn.rc

![Ataque mediante Powershell inyectando una ShellCode directamente en memoria](/investigacion/ataque-mediante-powershell-inyectando-una-shellcode-directamente-memoria/Captura7-300x177.png)
...
![Ataque mediante Powershell inyectando una ShellCode directamente en memoria](/investigacion/ataque-mediante-powershell-inyectando-una-shellcode-directamente-memoria/Captura8-300x113.png)
