...
![Inyección SQL ](https://nullsector.co/wp-content/uploads/2018/01/sqlinjection2-300x158.png)
...
![ficando y explotando de manera practica una pagina vulnerable a SQL Injection  manualmente](https://nullsector.co/wp-content/uploads/2018/01/Captura-1.png)
...
![ficando y explotando de manera practica una pagina vulnerable a SQL Injection  manualmente](https://nullsector.co/wp-content/uploads/2018/01/Captura2-1.png)
...
![ficando y explotando de manera practica una pagina vulnerable a SQL Injection  manualmente](https://nullsector.co/wp-content/uploads/2018/01/Captura3-1.png)

**4 –** Nuestros instintos de Hacker se despiertan y comprobamos poniendo un simple **» ‘ »** a el final de la sentencia para poder detectar rápidamente que el sitio es vulnerable a SQL Injection!, en este caso podemos ver que nos indica la pagina tiene un error en la sintaxis.![ficando y explotando de manera practica una pagina vulnerable a SQL Injection  manualmente](https://nullsector.co/wp-content/uploads/2018/01/Captura4-1.png)

**5 –**  Empezamos con un simple **Union** para poder inyectarle nuestra propia sentencia, nuestro objetivo es lograr encontrar la cantidad de columnas que tiene la sentencia ya dispuesta en la pagina para poder ejecutar la nuestra.![ficando y explotando de manera practica una pagina vulnerable a SQL Injection  manualmente](https://nullsector.co/wp-content/uploads/2018/01/Captura5-1.png)

**6 –**  Lo logramos, encontramos que las columnas contenidas en la sentencia equivalen a 11.

![ficando y explotando de manera practica una pagina vulnerable a SQL Injection  manualmente](https://nullsector.co/wp-content/uploads/2018/01/Captura6-1.png)

**7 –**  Utilizamos **«@@version»** con este comando podemos ver la versión del motor de base de datos alojado en esta web.

![ficando y explotando de manera practica una pagina vulnerable a SQL Injection  manualmente](https://nullsector.co/wp-content/uploads/2018/01/Captura7.png)
...
![ficando y explotando de manera practica una pagina vulnerable a SQL Injection  manualmente](https://nullsector.co/wp-content/uploads/2018/01/Captura8-1.png)
...
![ficando y explotando de manera practica una pagina vulnerable a SQL Injection  manualmente](https://nullsector.co/wp-content/uploads/2018/01/Captura10-1.png)

**10** – Encontramos Oro! columna **uname** y **pass** esto quiere decir que podremos tener un posible acceso a el portal.

![ficando y explotando de manera practica una pagina vulnerable a SQL Injection  manualmente](https://nullsector.co/wp-content/uploads/2018/01/Captura12.png)
...
![ficando y explotando de manera practica una pagina vulnerable a SQL Injection  manualmente](https://nullsector.co/wp-content/uploads/2018/01/Captura13.png)
